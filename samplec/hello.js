...
var Module = typeof createTest !== 'undefined' ? createTest : {};
...
var INITIAL_INITIAL_MEMORY = Module['INITIAL_MEMORY'] || 2146435072;if (!Object.getOwnPropertyDescriptor(Module, 'INITIAL_MEMORY')) Object.defineProperty(Module, 'INITIAL_MEMORY', { configurable: true, get: function() { abort('Module.INITIAL_MEMORY has been replaced with plain INITIAL_INITIAL_MEMORY (the initial value can be provided on Module, but after startup the value is only looked for on a local variable of that name)') } });
...
var ASM_CONSTS = {
  5451948: function() {throw 'Canceled!'},  
 5452170: function($0, $1) {setTimeout(function() { _do_emscripten_dispatch_to_thread($0, $1); }, 0);},  
 5452272: function() {return TOTAL_STACK}
};
...
var proxiedFunctionTable = [null,_atexit,_tzset,___sys_access,___sys_fcntl64,___sys_fstat64,___sys_getdents64,___sys_ioctl,___sys_lstat64,___sys_mkdir,___sys_mmap2,___sys_munmap,___sys_open,___sys_poll,___sys_prlimit64,___sys_read,___sys_rename,___sys_rmdir,___sys_socketcall,___sys_stat64,___sys_unlink,_emscripten_set_canvas_element_size_main_thread,_fd_close,_fd_fdstat_get,_fd_read,_fd_seek,_fd_write,_getaddrinfo,_sysconf];
...
/** @type {function(...*):?} */
var dynCall_vijjjid = Module["dynCall_vijjjid"] = createExportWrapper("dynCall_vijjjid");
...
var _ff_h264_cabac_tables = Module['_ff_h264_cabac_tables'] = 2225318;
var _main_thread_futex = Module['_main_thread_futex'] = 17194512;
